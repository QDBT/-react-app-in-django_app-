...
function App() {
  ...
  const doGood = (event)=>{
    ...
    .then(res=>{
      getMsgs(pnum);
      if(res=='OK'){
        setMessage('You just liked');
      } else {
        setMessage('Its already liked');
      }
    });
  }
  const onFirst = (event) =>{
    ...
    <div className="content">
      <textarea className ="form-control"
                ...
                <span className="h6 text-primary">
                  ...
                  <span className="float-right">
                    <span className="mx-2">
                      ...
                      <button clasName="py-0 px-1 btn btn-outline-primary" id={obj.pk} onClick={doGood}>good!</button>
                      </span>
                      </p>  
            </td></tr>
          ))}
        ...
        <ul class="pagination justify-content-center">
          ...
          <li class="page-item">
            <a class="page-link"onClick={onPrev}>
              &laquo; prev
            </a>
          </li>
          <li class="page-item">
          ...
          <li class="page-item">
            <a class="page-link" href="#" onClick={onLast}>
              last &raquo;
            </a>
          </li>
        </ul>
